...
(function () {
   ...
   * @property {{resources: Object<string,number>}} reward
  ...
  const ACHIEVEMENT_DEFS = [
    { id: 'first_upgrade', name: '基業初立', desc: '完成一次建築升級',
      reward: { resources: { gold: 100 } }, condition: { type: 'buildingLevelAny', atLeast: 2 } },
    { id: 'capital5', name: '固若金湯', desc: '主城升級至 5 級',
      reward: { resources: { gold: 400, stone: 300 } }, condition: { type: 'buildingLevel', building: 'capital', atLeast: 5 } },
    { id: 'capital10', name: '王城巍峨', desc: '主城升級至 10 級',
      reward: { resources: { gold: 1500 } }, condition: { type: 'buildingLevel', building: 'capital', atLeast: 10 } },
    { id: 'five_heroes', name: '五虎齊聚', desc: '擁有至少 5 名武將',
      reward: { resources: { gold: 300 } }, condition: { type: 'heroCount', atLeast: 5 } },
    { id: 'ten_heroes', name: '猛將如雲', desc: '擁有至少 10 名武將',
      reward: { resources: { gold: 600 } }, condition: { type: 'heroCount', atLeast: 10 } },
    { id: 'hero_lv10', name: '身經百戰', desc: '任一武將等級達到 10',
      reward: { resources: { food: 300, wood: 300 } }, condition: { type: 'heroLevelAny', atLeast: 10 } },
    { id: 'first_win', name: '初戰告捷', desc: '取得第一次戰鬥勝利',
      reward: { resources: { gold: 150 } }, condition: { type: 'battleWinCount', atLeast: 1 } },
    { id: 'ten_wins', name: '百戰百勝', desc: '累計取得 10 次戰鬥勝利',
      reward: { resources: { gold: 500 } }, condition: { type: 'battleWinCount', atLeast: 10 } },
    { id: 'five_missions', name: '初露鋒芒', desc: '完成 5 個主線戰役關卡',
      reward: { resources: { gold: 400 } }, condition: { type: 'missionCompletedCount', atLeast: 5 } },
    { id: 'all_missions', name: '天下歸一', desc: '完成全部主線戰役關卡',
      reward: { resources: { gold: 2000, food: 1000, wood: 1000, stone: 1000 } }, condition: { type: 'missionCompletedAll' } },
    { id: 'first_item', name: '寶物初現', desc: '取得第一件裝備',
      reward: { resources: { gold: 150 } }, condition: { type: 'itemEverObtained' } },
    { id: 'full_equip', name: '披堅執銳', desc: '讓任一武將裝備滿四個部位',
      reward: { resources: { gold: 500 } }, condition: { type: 'heroFullyEquippedAny' } }
  ];
