...
(function () {
  ...
  const MISSION_DEFS = [
    ...
    { id: 'm2', chapter: 1, name: '古城會', flavor: '張飛據守古城，疑心關羽變節，需以武力說明忠義。',
      ...
      reward: { resources: { wood: 300, stone: 150 }, unlockHeroId: 'zhangfei', ingot: 30 }, requires: ['m1'] },
    { id: 'm3', chapter: 1, name: '過五關斬六將', flavor: '關羽護送二位嫂嫂北返，沿途需連破數道關卡。',
      enemy: { heroId: null, name: '把關諸將', units: { infantry: 30, crossbowman: 15 } },
      reward: { resources: { gold: 250 }, unlockHeroId: 'guanyu', itemReward: 'sword_bronze_dragon', ingot: 40 }, requires: ['m2'] },
    { id: 'm4', chapter: 2, name: '隆中對', flavor: '三顧茅廬，求得諸葛亮、龐統獻上鼎足三分之策。',
      enemy: { heroId: null, name: '山寨土匪', units: { infantry: 15, cavalry: 10 } },
      reward: { resources: { food: 400, gold: 300 }, unlockHeroId: 'zhugeliang', itemReward: 'fan_feather', ingot: 40 }, requires: ['m3'] },
    { id: 'm5', chapter: 2, name: '入川之戰', flavor: '魏延獻計奇襲，助劉備奪取益州立足之地。',
      enemy: { heroId: null, name: '劉璋守軍', units: { infantry: 35, spearman: 20 } },
      reward: { resources: { stone: 350, gold: 200 }, unlockHeroId: 'weiyan', ingot: 40 }, requires: ['m4'] },
    ...
    { id: 'm6', chapter: 3, name: '官渡之戰', epic: true, flavor: '曹操以寡擊眾，奇襲烏巢糧倉，一舉扭轉北方局勢。',
      ...
      reward: { resources: { food: 600, wood: 400, gold: 400 }, unlockHeroId: 'dianwei', itemReward: 'armor_black_iron', ingot: 150 }, requires: ['m5'] },
    { id: 'm7', chapter: 3, name: '許都定策', flavor: '司馬懿與郭嘉先後獻策，助曹魏穩固中原根基。',
      enemy: { heroId: null, name: '流寇餘黨', units: { infantry: 40, cavalry: 20 } },
      reward: { resources: { gold: 350 }, unlockHeroId: 'simayi', ingot: 50 }, requires: ['m6'] },

    { id: 'm8', chapter: 4, name: '江東立業', flavor: '孫權承父兄之業，穩守江東，靜待天時。',
      enemy: { heroId: null, name: '山越叛軍', units: { infantry: 30, spearman: 15 } },
      reward: { resources: { food: 350, stone: 250 }, unlockHeroId: 'sunquan', ingot: 40 }, requires: ['m5'] },
    { id: 'm9', chapter: 4, name: '赤壁之戰', epic: true, flavor: '周瑜黃蓋合演苦肉連環，一炬燒盡曹軍戰船。',
      ...
      reward: { resources: { wood: 500, gold: 500 }, unlockHeroId: 'zhouyu', itemReward: 'incense_east_wind', ingot: 150 }, requires: ['m8', 'm6'] },
    { id: 'm10', chapter: 5, name: '夷陵之戰', epic: true, flavor: '陸遜連營七百里，火燒劉備連營，蜀漢元氣大傷。',
      ...
      reward: { resources: { gold: 600 }, unlockHeroId: 'luxun', itemReward: 'horse_hualiu', ingot: 150 }, requires: ['m9'] },

    { id: 'm11', chapter: 5, name: '七擒孟獲', flavor: '諸葛亮南征，七擒七縱，以德服人平定南中。',
      enemy: { heroId: null, name: '南蠻聯軍', units: { infantry: 50, cavalry: 25 } },
      reward: { resources: { food: 500, gold: 300 }, unlockHeroId: 'jiangwei', ingot: 60 }, requires: ['m10'] },
    { id: 'm12', chapter: 6, name: '六出祁山', flavor: '諸葛亮北伐中原，欲以攻代守，延續漢室氣運。',
      ...
      reward: { resources: { stone: 400, gold: 350 }, unlockHeroId: 'zhangjunyi', ingot: 60 }, requires: ['m11'] },
    { id: 'm13', chapter: 6, name: '合肥之圍', flavor: '張遼威震江東，以少勝多守住合肥要地。',
      enemy: { heroId: null, name: '吳軍前鋒', units: { infantry: 45, cavalry: 20 } },
      reward: { resources: { wood: 350, gold: 300 }, unlockHeroId: 'zhangliao', ingot: 60 }, requires: ['m9'] },
    { id: 'm14', chapter: 7, name: '荊州爭奪', flavor: '呂蒙奇襲荊州，三方勢力爲此戰略要地反覆交鋒。',
      ...
      reward: { resources: { gold: 450 }, unlockHeroId: 'lumeng', ingot: 70 }, requires: ['m13'] },
    { id: 'm15', chapter: 7, name: '天下歸一', epic: true, flavor: '三分歸一的最終決戰，誰主天下就在此役。',
      ...
      reward: { resources: { food: 800, wood: 800, stone: 800, gold: 800 }, unlockHeroId: null, itemReward: 'jade_heshi', ingot: 300 }, requires: ['m12', 'm14'] }
  ];
